...
while True:
    try:
        ...
        students.append({"rollno":roll, "assignments":assignments, "labs":labs, "midsem":midsem, "labs_total":labs_total, "midsem_total":midsem_total, "assignments_total":assignments_total, "endsem_total":endsem_total, "assessments":assessments, "marks":marks})
    except:
